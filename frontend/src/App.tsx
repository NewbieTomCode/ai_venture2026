...
export default function App() {
  ...
  // 2. State is now a single object or null instead of an array
        ...
        {step === 3 && scene && (
          <div className="mt-8 space-y-8 animate-in slide-in-from-bottom-10 fade-in duration-1000 fill-mode-both pb-20">
            <div className="flex items-center justify-between px-2">
              <h2 className="text-2xl font-black text-slate-900 tracking-tight underline decoration-indigo-500 decoration-4 underline-offset-8">Master Script</h2>
              <button onClick={() => {setStep(0); setSelectedFile(null);}} className="text-sm font-bold text-indigo-600 hover:text-indigo-700">New Vision</button>
            </div>
